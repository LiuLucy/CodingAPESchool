...
return [
    ...
    */
    ...
    'before_or_equal'      => ':attribute 必須要小於 :date 。',
    'between'              => [
    ...
    'max'                  => [
        ...
        'file'    => ':attribute 不能大於 :max kb之間。',
        'string'  => ':attribute 不能多於 :min 至 :max 個字元之間。',
        'array'   => ':attribute 最多有 :max 個元素。',
    ],
    'mimes'                => ':attribute 必須為 :values 的檔案。',
    'mimetypes'            => ':attribute 必須為 :values 的檔案。',
    'min'                  => [
        'numeric' => ':attribute 不能小於 :max 。',
        'file'    => ':attribute 不能小於 :min kb之間。',
        'string'  => ':attribute 不能小於 :min 個字元之間。',
